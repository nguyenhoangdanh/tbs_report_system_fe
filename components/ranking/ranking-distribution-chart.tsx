...
export function RankingDistributionChart({
  ...
  // Define colors theo bảng màu chuẩn từ ảnh
  const getRankingColor = (ranking: EmployeeRanking): string => {
    const colors = {
      [EmployeeRanking.EXCELLENT]: '#d946ef', // purple-500 - GIỎI
      [EmployeeRanking.GOOD]: '#22c55e', // green-500 - KHÁ
      [EmployeeRanking.AVERAGE]: '#eab308', // yellow-500 - TB
      [EmployeeRanking.BELOW_AVERAGE]: '#f97316', // orange-500 - YẾU
      [EmployeeRanking.POOR]: '#dc2626' // red-600 - KÉM
    }
