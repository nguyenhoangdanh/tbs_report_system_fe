...
// Enhanced Mobile Task Card Component with performance optimizations
const TaskCard = memo(function TaskCard({
  ...
  return (
    <motion.div
      initial={shouldReduceMotion ? false : { opacity: 0, y: 10 }} // Reduced from y: 20
      animate={shouldReduceMotion ? false : { opacity: 1, y: 0 }}
      exit={shouldReduceMotion ? undefined : { opacity: 0, y: -10 }} // Reduced exit animation
          ...
          <div className={`px-4 py-3 bg-gradient-to-r ${
            ...
            <div className="flex items-center justify-between">
              <motion.div 
                ...
                whileHover={shouldReduceMotion ? {} : { scale: 1.05 }} // Reduced scale
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="h-9 w-9 p-0 rounded-full bg-white/80 dark:bg-gray-800/80 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors duration-150"
                      title="Sao chép"
                    >
                      ...
                      return (
                        ...
                        >
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            className="h-9 w-9 p-0 rounded-full bg-white/80 dark:bg-gray-800/80 text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors duration-150"
                            title="Xóa"
                          >
              ...
              {isEditable && editingTask ? (
                ...
                >
                  <Textarea
                    ...
                    className="min-h-[60px] text-sm resize-none border-2 border-blue-200 focus:border-blue-400 rounded-lg transition-colors duration-150"
                    autoFocus
                    rows={2}
                  />
                </motion.div>
                ...
                <motion.div
                  className={`text-sm leading-relaxed p-3 rounded-lg border-2 cursor-pointer transition-all duration-150 ${
                    !task.taskName.trim()
                  ...
                  whileHover={shouldReduceMotion ? {} : { scale: 1.01 }} // Reduced scale
                  transition={shouldReduceMotion ? {} : { duration: 0.1 }}
                >
    ...
    <>
      ...
      >
        <Card>
          ...
          <CardContent className="p-0">
            {/* Mobile View - Cards with optimized animations */}
            ...
            {/* Desktop View - Table with minimal animations */}
